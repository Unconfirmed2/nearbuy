  ...
  public: {
    Tables: {
      ...
      analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "analytics_sku_fkey"
            columns: ["sku"]
            isOneToOne: false
      ...
      favorites: {
        ...
        Relationships: [
          {
            foreignKeyName: "favorites_sku_fkey"
            columns: ["sku"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      notification_preferences: {
        Row: {
          ...
          email_marketing_updates: boolean | null
          ...
          sms_order_confirmations: boolean | null
      ...
      sponsored_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "sponsored_items_sku_fkey"
            columns: ["sku"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
